setwd("/Users/johnrivas/Desktop/UHD/SCHOOL/Fall_2017/Predictive/Project/reception")
...
set.seed(123)
intrain <- createDataPartition(y = nfl.pt$Reception, p = 0.7, list = FALSE) 
assign("training", nfl.pt[intrain,] , envir = .GlobalEnv)
assign("testing",  nfl.pt[-intrain,] , envir = .GlobalEnv)

write.csv(training,"reception.train.csv")
write.csv(testing,"reception.test.csv")
