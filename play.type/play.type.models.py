...
history_path = os.path.normpath(os.getcwd() + os.sep + os.pardir + os.sep + 'history' + os.sep + 'play.type') 
models_path = os.path.normpath(os.getcwd() + os.sep + os.pardir + os.sep + 'h5' + os.sep + 'play.type') 

#load training data from csv file into numpy Array, last column is class label
Train = np.loadtxt(data_path + os.sep + 'play.type.train.one.hot.csv', delimiter = ',', skiprows = 1) #skip header/label row
...
#load training data from csv file into numpy Array, last column is class label
Test = np.loadtxt(data_path + os.sep + 'play.type.test.one.hot.csv', delimiter = ',', skiprows = 1) #skip header/label row
...
logistic_model.save(models_path + os.sep + 'play.type_logistic.h5')
deeplearning.SaveHistory(logistic_history,  history_path + os.sep  + 'play.type_logistic.hist.txt')

#DNN model
DNN_model, DNN_history = deeplearning.DeepNN(Train_Predictors, Train_class, NUM_PREDICTORS, NB_CLASSES)
DNN_model.save(models_path + os.sep + 'play.type_DNN.h5')
deeplearning.SaveHistory(DNN_history,  history_path + os.sep  + 'play.type_DNN.hist.txt')

DNNDropOut_model,DNNDropOut_history=deeplearning.DeepNNDropOut(Train_Predictors,Train_class,NUM_PREDICTORS, NB_CLASSES)
DNNDropOut_model.save(models_path + os.sep + 'play.type_DNNDropOut.h5')
deeplearning.SaveHistory(DNNDropOut_history,  history_path + os.sep  + 'play.type_DNNDropOut.hist.txt')
...
DNNDOMaxNorm_model.save(models_path + os.sep + 'play.type_DNNDOMaxNorm.h5')
deeplearning.SaveHistory(DNNDOMaxNorm_history,  history_path + os.sep  + 'play.type_DNNDOMaxNorm.hist.txt')

DNNLasso,DNNLasso_history=deeplearning.DeepNNLasso(Train_Predictors,Train_class,NUM_PREDICTORS, NB_CLASSES)
DNNLasso.save(models_path + os.sep + 'play.type_DNNLasso.h5')
deeplearning.SaveHistory(DNNLasso_history,  history_path + os.sep  + 'play.type_DNNLasso.hist.txt')

DNNRidge,DNNRidge_history=deeplearning.DeepNNRidge(Train_Predictors,Train_class,NUM_PREDICTORS, NB_CLASSES)
DNNRidge.save(models_path + os.sep + 'play.type_DNNRidge.h5')
deeplearning.SaveHistory(DNNRidge_history,  history_path + os.sep  + 'play.type_DNNRidge.hist.txt')

DNNElastic,DNNElastic_history=deeplearning.DeepNNElastic(Train_Predictors,Train_class,NUM_PREDICTORS, NB_CLASSES)
DNNElastic.save(models_path + os.sep + 'play.type_DeepNNElastic.h5')
deeplearning.SaveHistory(DNNElastic_history,  history_path + os.sep  + 'play.type_DNNElastic.hist.txt')
